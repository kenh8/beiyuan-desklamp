 ...
 */
@Api(value = "跨界权益",tags = "跨界权益相关")

@Controller
@RequestMapping("/swagger/api/tv/v1.0/crossborder/*")
public class ApiCrossBorderController extends BaseController {

    @ApiOperation(value = "一期跨界权益只有一张图片的功能")
    ...
    @RequestMapping(value = "getCrossProfile", method = RequestMethod.GET)
    public @ResponseBody
    Object getIntegral(){

        String resp = OkHttp3Utils.getInstance().doPost(Global.getServiceUrl() + HttpApiConstant.GET_CROSS_BRODER, new
                HashedMap());
        return resp;
    }
