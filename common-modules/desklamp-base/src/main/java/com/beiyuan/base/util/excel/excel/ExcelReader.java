...
public class ExcelReader {
	...
	public static void main(String[] args) {
		List<String[]> list = getExcelData("C:\\Users\\50273\\Desktop\\tmp\\yige\\G-7\\excel\\S-1.xlsx");
	 ...
	 * @return
	 */
	public static boolean judgeEmptyLine(String[] arr){
		for(String str:arr){
	 ...
	 * @return 字符串
	 */
	private static String getCellValue2007(Cell cell ){
		String value = null;
		if (null != cell) {
			switch (cell.getCellType()) {
