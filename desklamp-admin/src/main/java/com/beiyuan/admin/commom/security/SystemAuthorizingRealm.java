 ...
 */
package com.beiyuan.admin.commom.security;


import com.beiyuan.admin.commom.SystemUserUtils;
import com.beiyuan.admin.commom.security.SystemService;
import com.beiyuan.admin.commom.security.UsernamePasswordToken;
...
public class SystemAuthorizingRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authToken) throws AuthenticationException {
        ...
        try {
			...
			if(user.getStatus()==2) throw new AuthenticationException("账号存在异常");
