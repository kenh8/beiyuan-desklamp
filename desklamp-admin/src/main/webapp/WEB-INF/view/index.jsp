...
<html>
    <head>
        ...
        <link rel="shortcut icon" type="images/x-icon" href="${ctx}/assets/images/img_js.jpg">
        ...
        <![endif]-->
        <link href="${ctx}/assets/js/common/bootstrap-table/bootstrap-table-jumpto.css" rel="stylesheet" type="text/css"/>
    ...
    <body class="fixed-left main-body" style="overflow: hidden;">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="javascript:void(0);" class="logo"><span>贝远智教</span></a>
                    </div>
                </div>
                            ...
                            <ul class="nav navbar-nav navbar-right pull-right">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="${ctx}/pms/user/toModifyPwd" data-toggle="modal"
                                               data-target="#base_modal"><i class="md md-settings"></i> 修改密码</a></li>
        ...
        <script src="${ctx}/assets/js/common/base/base-math.js"></script>
        ...
        <script src="${ctx}/assets/js/common/bootstrap-table/bootstrap-table-jumpto.js"></script>
        ...
        <script type="text/javascript" src="${ctx}/assets/js/common/jquery.form.js"></script>
        <!-- modal -->
