        ...
        <div class="mt20">
            ...
            <table data-toggle="table" data-classes="table table-hover"
                ...
                <tr>
                    ...
                    <th data-field="jobGroup" data-align="left" data-formatter="autoWrapRender">任务分组</th>
                    <th data-field="beanClass" data-align="left" data-formatter="autoWrapRender">类名</th>
                    <th data-field="methodName" data-align="left" data-formatter="autoWrapRender">方法名</th>
                    <th data-field="springId" data-align="left" data-formatter="autoWrapRender">实例ID</th>
