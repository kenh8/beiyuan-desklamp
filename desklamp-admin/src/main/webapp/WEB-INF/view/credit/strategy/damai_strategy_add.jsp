...
<form class="form-horizontal tasi-form" method="post"
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div id="clientId" class="col-sm-9">
                <div class="radio radio-info radio-inline">
                    <input checked type="radio" id="clientId1" value="1" name="clientId">
        ...
        <div class="form-group">
            ...
            <div id="isEffective" class="col-sm-9">
                <div class="radio radio-info radio-inline">
                    <input checked type="radio" id="isEffective1" value="1" name="isEffective">
                    <label for="isEffective1">有效</label>
                </div>
                <div class="radio radio-info radio-inline">
                    <input type="radio" id="isEffective2"  value="0" name="isEffective">
        ...
        <div class="form-group">
            ...
            <input type="text" id="strategyRuleYuan" name="strategyRuleYuan" id="strategyRuleYuan" placeholder="请输入消费策略" data-error="请输入消费策略" required  onkeyup="limitTwoPoint(this);" onafterpaste="limitTwoPoint(this);">元
            <input type="text"id="strategyRuleIntegral" name="strategyRuleIntegral" placeholder="请输入策略积分" data-error="请输入策略积分" required  onKeyUp="value=value.replace(/[^0-9]/g,'')">积分
            </label>
        </div>
        <div class="form-group">
            <label for="limit" class="col-sm-2 col-xs-2 control-label">单品积分上限</label>
            <div class="col-sm-4">
                <input type="text" name="limit" class="form-control" id="limit" placeholder="请输入单品积分上限" data-error="请输入单品积分上限" onKeyUp="value=value.replace(/[^0-9]/g,'')" required>
                <div class="help-block with-errors"></div>
            </div>
        </div>
    </div>
...
<script src="${pageContext.request.contextPath}/assets/js/module/credit/strategy/damai_strategy_add.js"/>
