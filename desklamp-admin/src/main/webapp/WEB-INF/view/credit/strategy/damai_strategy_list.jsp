...
<div class="row">
    <div class="col-sm-12">
        <h4 class="pull-left page-title">优购消费积分策略管理</h4>
        <ol class="breadcrumb pull-right">
            <li><a data-target="divload" data-div="baseContainer">优购消费积分策略管理</a></li>
            <li class="active">优购消费积分策略列表</li>
        </ol>
    </div>
</div>
    ...
    <div class="panel-body">
        <div class="mt20">
            <div class="m-b-10">
                <form id="paramForm" class="form-inline" tableId="strategyTableId" onsubmit="return false;">
                    ...
                    <div class="form-group">
                        <a class="btn btn-primary"  href="${pageContext.request.contextPath}/credit/damaiStrategy/add" data-toggle="modal" data-target="#base_modal">添加</a>
            ...
            <table data-toggle="table" data-classes="table table-hover"
                   ...
                   data-url="${pageContext.request.contextPath}/credit/damaiStrategy/listData" id="strategyTableId"
                ...
                <tr>
                    ...
                    <th data-field="limit" data-align="center">积分上限</th>
                    <th data-field="clientId" data-align="center"  data-formatter="renderClientType">客户端</th>
                    <th data-field="isEffective" data-align="center"  data-formatter="renderEffectiveType">状态</th>
...
<script src="${pageContext.request.contextPath}/assets/js/module/credit/strategy/damai_strategy_list.js"></script>
</html>
