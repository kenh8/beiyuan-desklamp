...
<div class="row">
    <div class="col-sm-12">
        <h4 class="pull-left page-title">影视退款详情</h4>
...
<div class="panel adapt-window-height">
    <div class="panel-body">
        <div class="mt20">
            <div class="m-b-10">
                <input type="hidden" id="product" value="2006">
            ...
            <table data-toggle="table" data-classes="table table-bordered  text-nowrap"
                   ...
                   data-url="${pageContext.request.contextPath}/credit/refund/listData?productType=2006&refundStatus=2"
            ...
            <table data-toggle="table" data-classes="table table-bordered  text-nowrap"
                   data-pagination="true" data-striped="true"
                   data-url="${pageContext.request.contextPath}/credit/refund/listData?productType=2006&refundStatus=3"
            ...
            <table data-toggle="table" data-classes="table table-bordered  text-nowrap"
                   data-pagination="true" data-striped="true"
                   data-url="${pageContext.request.contextPath}/credit/refund/listData?productType=2006&refundStatus=4"
            ...
            <table data-toggle="table" data-classes="table table-bordered  text-nowrap"
                   data-pagination="true" data-striped="true"
                   data-url="${pageContext.request.contextPath}/credit/refund/listData?productType=2006&refundStatus=5"
