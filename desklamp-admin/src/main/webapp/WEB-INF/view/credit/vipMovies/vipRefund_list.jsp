...
<div class="row">
    <div class="col-sm-12">
        <h4 class="pull-left page-title">ViP退款详情</h4>
...
<div class="panel adapt-window-height">
    <div class="panel-body">
        <div class="mt20">
            <div class="m-b-10">
                <input type="hidden" id="product" value="2009">
                <form id="paramForm" class="form-inline" tableId="vipRefundTableId" onsubmit="return false;">
            ...
            <table data-toggle="table" data-classes="table table-bordered  text-nowrap"
                   ...
                   data-url="${pageContext.request.contextPath}/credit/refund/listData?productType=2009&refundStatus=2"
            ...
            <table data-toggle="table" data-classes="table table-bordered  text-nowrap text-nowrap"
                   data-pagination="true" data-striped="true"
                   data-url="${pageContext.request.contextPath}/credit/refund/listData?productType=2009&refundStatus=3"
            ...
            <table data-toggle="table" data-classes="table table-bordered  text-nowrap"
                   data-pagination="true" data-striped="true"
                   data-url="${pageContext.request.contextPath}/credit/refund/listData?productType=2009&refundStatus=4"
            ...
            <table data-toggle="table" data-classes="table table-bordered  text-nowrap"
                   data-pagination="true" data-striped="true"
                   data-url="${pageContext.request.contextPath}/credit/refund/listData?productType=2009&refundStatus=5"
