...
<div class="row">
    <div class="col-sm-12">
        <h4 class="pull-left page-title">商品包退款详情订单</h4>
...
<div class="panel adapt-window-height">
    <div class="panel-body">
        <div class="mt20">
            <div class="m-b-10">
                <input type="hidden" id="product" value="21693">
            ...
            <table data-toggle="table" data-classes="table table-bordered  text-nowrap"
                   ...
                   data-url="${pageContext.request.contextPath}/credit/refund/listData?productType=21693&refundStatus=2"
